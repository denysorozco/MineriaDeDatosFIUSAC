...
```{r}
### Año 01 - 2013
datos_2013_D <- read_sav("")
datos_2013_DF <- read_sav("")

### Año 02 - 2014
datos_2014_D <- read_sav("")
datos_2014_DF <- read_sav("")

### Año 03 - 2015
datos_2015_D <- read_sav("")
datos_2015_DF <- read_sav("")

### Año 04 - 2016
datos_2016_D <- read_sav("")
datos_2016_DF <- read_sav("")

### Año 05 - 2017
datos_2017_D <- read_sav("_20181226142907_D_2017.sav")
datso_2017_DF <- read_sav("20181226143403_DF_2017.sav")
...
```{r}
datos_d <- bind_rows(datos_2017_D,datos_2018_D,datos_2019_D,datos_2020_D,datos_2021_D,datos_2022_D)

datos_df <- bind_rows(datos_2018_DF,datos_2019_DF,datos_2020_DF,datos_2021_DF,datos_2022_DF)
```
